...
if (rex::isBackend()) {
    ...
    rex_view::addCssFile($this->getAssetsUrl('fonts/fontawesome-free-5.14.0-web/css/all.min.css'));
    // adds compatibility to backend icons
    rex_view::addCssFile($this->getAssetsUrl('fonts/fontawesome-free-5.14.0-web/css/v4-shims.min.css'));
